...
@EFragment(R.layout.fragment_tab_home_new_chart)
public class FragmentHomeNewChart extends CustomFragment {
    @ViewById
    ...
    public static FragmentHomeNewChart newInstance(ArrayList<Song> items) {
        FragmentHomeNewChart f = new FragmentHomeNewChart_();
        Bundle b = new Bundle();
    ...
    private class OnItemClickListener extends RecyclerItemClickListener.SimpleOnItemClickListener{
        ...
        public void onItemClick(View view, int position) {
            FragmentHomeNewChart.this.onItemClick(view, position);
        }
    }
