...
@EFragment
public abstract class CustomFragmentWithRecyclerView extends CustomFragment {
    @ViewById
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerDividerDecoration = new RecyclerDividerDecoration(getActivity());
    }
    ...
    protected void setupRecyclerView() {
        ...
        if(isGridType){
            mLinearLayoutManager = new GridLayoutManager(getActivity(), gridColumnCount);
        }else{
    ...
    private class SwipeRefreshListener implements SwipeRefreshLayout.OnRefreshListener{
        ...
        public void onRefresh() {
            ...
            CustomFragmentWithRecyclerView.this.onRefresh();
        }
    }
    ...
    private class OnItemClickListener extends RecyclerItemClickListener.SimpleOnItemClickListener{
        ...
        public void onItemClick(View view, int position) {
            CustomFragmentWithRecyclerView.this.onItemClick(view, position);
        }
    }
}